...
export function SpeakableMarketBlock({ text }: { text: string }) {
  return (
    <section className="mb-16 max-w-3xl">
      <p
        className="speakable-summary text-lg text-slate-600 leading-relaxed"
        data-speakable
      >
        {text}
      </p>
...
export function EconomicDriversSection() {
  return (
    <section className="mb-16">
      ...
      <HeadingPhoto heading="What Drives the Nevada Real Estate Market?" />
...
export function CityMarketProfilesSection() {
  return (
    <section className="mb-16">
      ...
      <HeadingPhoto heading="Las Vegas Valley Cities — Market Profiles" />
        ...
        {cityMarketProfiles.map((city) => (
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 text-sm">
              ...
              <Link
                href={city.mapPath}
                className="text-slate-600 inline-flex items-center hover:text-blue-600"
              >
...
export function MarketSignalsSection() {
  const signals = [
    ...
    { label: "List-to-Sale Ratio", value: valleyMarketSignals.listToSaleRatio },
    {
      ...
      value: valleyMarketSignals.sellerConcessions,
    },
  ...
  return (
    <section className="mb-16">
      ...
      <p className="text-slate-600 text-sm max-w-3xl">
        ...
        {valleyMarketSignals.buyerLeverage}.{" "}
        {valleyMarketSignals.inventoryTrend}.
      </p>
    </section>
  );
}
  ...
  return (
    <section className="mb-16">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div>
          <p
            className="speakable-summary text-slate-600 leading-relaxed mb-6"
            data-speakable
          >
