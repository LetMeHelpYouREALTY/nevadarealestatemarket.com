...
type PageHeroProps = {
  ...
  size?: "default" | "home";
  /**
   * RealScout office listings directly under the hero (default: true).
   * Set false only when the page renders its own widget in that slot.
   */
  showRealScout?: boolean;
};

/**
 * Full-bleed hero with optimized background, brand signal, and RealScout
 * listings immediately below — sitewide pattern for every page using PageHero.
 */
