...
const neighborhoods = [
  {
    name: "Summerlin",
    description:
      "Master-planned community with Red Rock views, parks and trails, and 150+ parks",
    medianPrice: "$625,000",
    daysOnMarket: 22,
  },
  {
    name: "Henderson",
    description:
      "Nevada's second-largest city with amenity-rich communities and walkable amenities",
    medianPrice: "$485,000",
    daysOnMarket: 24,
  },
  {
  ...
  return (
    <>
      ...
      <PageHero
        ...
        subtitle="Browse Nevada MLS listings with Dr. Jan Duffy."
        className="pt-24"
      />
      <main className="pt-8 pb-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <h2 className="sr-only">Las Vegas Homes for Sale</h2>
          ...
          <section className="mb-16 max-w-6xl mx-auto">
            ...
            <p className="text-slate-600 text-center max-w-3xl mx-auto mb-8">
              ...
              communities, homes near parks and trails, or affordable new
              construction, our comprehensive search tools help you find exactly
              what you're looking for. Browse the most popular searches below or
              use the advanced filters to customize your home search experience.
            </p>
          ...
          <section className="mb-16 max-w-6xl mx-auto">
            ...
            <p className="text-slate-600 text-center max-w-3xl mx-auto mb-8">
              ...
              resort-style living of Summerlin to the amenity-rich communities
              of Henderson. Understanding these differences is crucial to
              finding a home that fits your needs. As a Berkshire Hathaway
              HomeServices agent serving Las Vegas since 2013, Dr. Jan Duffy
              provides expert guidance on which neighborhoods match your
              priorities—whether that's schools, commute times, amenities, or
