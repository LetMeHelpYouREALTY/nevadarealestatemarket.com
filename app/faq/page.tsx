  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Call or text (702) 500-1955 or email homes@heyberkshire.com. Office located at 3185 St Rose Pkwy, Suite 101, Henderson, NV 89052. Open daily 6 AM – 9 PM.",
      },
      {
...
export default function FAQPage() {
  return (
    <>
      ...
      <Navbar />
      <PageHero
        hero={getHeroImageByKey("faq")}
        badge="Nevada Real Estate FAQ"
        title="Frequently Asked Questions"
        subtitle="Straight answers on prices, process, and neighborhoods."
        className="pt-24"
      />
