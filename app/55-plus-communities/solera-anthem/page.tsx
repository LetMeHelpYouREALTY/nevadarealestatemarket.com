...
export const metadata: Metadata = {
  alternates: {
    canonical:
      "https://www.nevadarealestatemarket.com/55-plus-communities/solera-anthem",
  },
  title:
    "Solera at Anthem Homes for Sale | Intimate Guard-Gated 55+ Henderson | Dr. Jan Duffy",
  description:
    "Solera at Anthem - intimate guard-gated 55+ community in Henderson. Homes from $380K-$650K. Lower HOA fees, close-knit atmosphere. Dr. Jan Duffy, BHHS. Call (702) 500-1955.",
  keywords: [
...
export default function SoleraAnthemPage() {
  return (
    <>
      ...
      <PageHero
        hero={
          getCommunityHeroImage("solera-anthem") ??
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-slate-600">
              The close-knit alternative to mega-communities. Guard-gated 55+
              living in Henderson's Anthem master plan.
            </p>
          </div>
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-slate-700">
              ...
              <HeadingPhoto heading="About Solera at Anthem" />
              <p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">
                      Solera sits inside Henderson's Anthem master plan with a
                      24/7 staffed guard gate plus parks, trails, and nearby
                      retail along St. Rose Parkway.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm">
                    24/7 staffed gate plus Henderson parks, trails, and St. Rose
                    Parkway retail within a short drive
                  </p>
                </div>
              </div>
              <div className="flex items-start">
