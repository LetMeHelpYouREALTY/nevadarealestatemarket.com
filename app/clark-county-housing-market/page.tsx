    ...
    <>
      ...
      >
        ...
        <section className="mb-16">
          ...
          <HeadingPhoto heading="About Clark County, Nevada" />
          ...
          <p className="text-slate-600 leading-relaxed max-w-3xl">
            Clark County accounts for the vast majority of Nevada&apos;s
            residential sales. No state income tax, corporate relocations, and
            California equity migration continue to fuel demand — while limited
            land in premium master-planned communities keeps luxury inventory
            tight.
          </p>
        </section>
