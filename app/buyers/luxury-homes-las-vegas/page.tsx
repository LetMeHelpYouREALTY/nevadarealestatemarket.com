...
export const metadata: Metadata = {
  alternates: {
    canonical:
      "https://www.nevadarealestatemarket.com/buyers/luxury-homes-las-vegas",
  },
...
export default function LuxuryHomesPage() {
  return (
    <>
      ...
      <Navbar />
      <PageHero
        hero={getHeroImageByKey("buyers-luxury-homes-las-vegas")}
        title="Las Vegas Luxury Real Estate"
        subtitle="Las Vegas Luxury Real Estate real estate guidance from Dr. Jan Duffy — Nevada Real Estate Market."
        className="pt-24"
      />
              ...
              <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-lg">
                ...
                <div className="p-6">
                  ...
                  <p className="text-slate-600 mb-4">
                    ...
                    Henderson's walkable amenities rates create an unmatched
                    combination.
                  </p>
                  <ul className="space-y-2 mb-4">
                    <li className="flex items-center text-sm text-slate-700">
