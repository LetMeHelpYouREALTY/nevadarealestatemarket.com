...
export const metadata: Metadata = {
  ...
  description:
    "Looking to buy a home in Las Vegas? Dr. Jan Duffy with Berkshire Hathaway HomeServices Nevada Properties guides you through every step. Free buyer consultation. Call (702) 500-1955.",
  keywords: [
    "buy home Las Vegas",
...
const neighborhoods = [
  ...
  },
  {
    name: "Henderson",
    price: "$485K",
    description: "Amenity-rich with walkable amenities rates",
  },
  {
    name: "Green Valley",
    price: "$520K",
...
export default function BuyersPage() {
  return (
    <>
      ...
      <Navbar />
      <PageHero
        hero={getHeroImageByKey("buyers")}
        badge="Buyer Representation"
        title="Buy Your Las Vegas Home with Confidence"
        subtitle="Buy a Las Vegas Valley home with Top 1% guidance from Dr. Jan Duffy."
        className="pt-24"
      />
      <main className="pt-8 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <h2 className="sr-only">Buy Your Las Vegas Home with Confidence</h2>
          ...
          <section className="mb-16 bg-slate-50 rounded-2xl p-8 md:p-12 max-w-6xl mx-auto">
            ...
            <p className="text-slate-600 text-center max-w-3xl mx-auto mb-8">
              ...
              construction, Dr. Jan helps you find the perfect neighborhood.
              Here's a quick guide to median prices and what each area offers.
            </p>
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-slate-600 text-sm">
                  Dr. Jan has served Las Vegas since 2013 with $127M+ in
                  transactions
                </p>
              </div>
              <div className="text-center">
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            ...
            <p className="text-slate-600 text-center max-w-3xl mx-auto mb-8">
              ...
              (702) 500-1955 for a free consultation.
            </p>
