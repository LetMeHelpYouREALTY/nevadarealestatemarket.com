...
export const metadata: Metadata = {
  alternates: {
    canonical:
      "https://www.nevadarealestatemarket.com/buyers/california-relocator",
  },
  title:
...
export default function CaliforniaRelocatorPage() {
  return (
    <>
      ...
      <Navbar />
      <PageHero
        hero={getHeroImageByKey("buyers-california-relocator")}
        title="California Relocator"
        subtitle="California Relocator real estate guidance from Dr. Jan Duffy — Nevada Real Estate Market."
        className="pt-24"
      />
              ...
              <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  <p className="text-slate-600 mb-4">
                    ...
                    parks and trails, Downtown Summerlin shopping, and Red Rock
                    Canyon views.
                  </p>
              ...
              <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  <p className="text-slate-600 mb-4">
                    ...
                    data center, parks and trails, and "Henderson's
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <p className="text-slate-600">
                  ...
                  (amenity-rich like San Diego suburbs), and The Ridges
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <p className="text-slate-600">
                  ...
                  Many California families choose areas with parks and trails or
                  consider private options. Dr. Jan provides school-specific
