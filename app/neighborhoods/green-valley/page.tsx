...
export const metadata: Metadata = {
  alternates: {
    canonical:
      "https://www.nevadarealestatemarket.com/neighborhoods/green-valley",
  },
...
export default function GreenValleyPage() {
  return (
    <>
      ...
      <PageHero
        hero={
          getCommunityHeroImage("green-valley") ??
          getHeroImageByKey("henderson")
        }
        title="Berkshire Hathaway HomeServices Green Valley"
        subtitle="Berkshire Hathaway HomeServices Green Valley real estate guidance from Dr. Jan Duffy — Nevada Real Estate Market."
        className="pt-24"
      />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-slate-600">
              Henderson's original master-planned community. Find your Green
              Valley home with <strong>Berkshire Hathaway HomeServices</strong>{" "}
              and Dr. Jan Duffy.
            </p>
          </div>
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <div className="prose prose-lg max-w-none text-slate-700">
              ...
              <p>
                ...
                community. Established in 1988, Green Valley pioneered the
                ...
                <div className="bg-slate-50 p-6 rounded-xl">
                  <div className="flex items-center mb-4">
                    ...
                    <h4 className="font-bold text-slate-900 text-lg">
                      Mature Landscaping & Character
                    </h4>
                  </div>
                  <p className="text-slate-600">
                    Green Valley's 35+ years of growth have created tree-lined
                    streets and lush landscaping that newer communities simply
                    can't match. The established vegetation provides shade,
                    privacy, and a sense of permanence. Many homes feature
                    larger lots than you'll find in newer developments, with
                    mature fruit trees and professional landscaping.
                  </p>
                </div>
                <div className="bg-slate-50 p-6 rounded-xl">
                  <div className="flex items-center mb-4">
                  ...
                  <p className="text-slate-600">
                    The District is Henderson's premier outdoor shopping and
                    entertainment destination. This pedestrian-friendly center
                    features upscale retailers, diverse dining options, a luxury
                    movie theater, and regular community events. Green Valley
                    residents enjoy easy access to this lifestyle amenity that
                    draws visitors from across the valley.
                  </p>
                </div>
              </div>
              ...
              <div className="not-prose bg-white border border-slate-200 rounded-xl p-6">
                <p className="text-slate-700 mb-4">
                  Green Valley is home to some of Henderson's most sought-after
                  schools with 35+ years of proven excellence:
                </p>
                ...
                <table className="w-full bg-white border border-slate-200 rounded-lg">
                  ...
                  <tbody className="divide-y divide-slate-200">
                    ...
                    <tr className="bg-slate-50">
                      ...
                      <td className="px-4 py-3">7 miles</td>
                    ...
                    <tr className="bg-slate-50">
                      ...
                      <td className="px-4 py-3">20 miles</td>
                ...
                <div className="bg-slate-50 rounded-xl p-6">
                  ...
                  <ul className="text-slate-600 text-sm space-y-2">
                    <li>
                      ...
                      Premier outdoor shopping with Anthropologie, Crate &
                      Barrel, REI, and 60+ shops.
                    </li>
                    <li>
                      <strong>Green Valley Ranch Resort:</strong> Casino, spa,
                      multiple restaurants, concert venue.
                    </li>
                    <li>
                      <strong>Trader Joe's & Whole Foods:</strong> Both
                      locations within 5 minutes of most Green Valley homes.
                    </li>
                    <li>
                      <strong>Galleria at Sunset:</strong> 10-minute drive to
                      major mall with Macy's, Dillard's, 140+ stores.
                    </li>
                  </ul>
                </div>
                <div className="bg-slate-50 rounded-xl p-6">
                  ...
                  <ul className="text-slate-600 text-sm space-y-2">
                    <li>
                      <strong>Whitney Mesa Recreation Area:</strong> Dog park,
                      trails, mountain views.
                    </li>
                    <li>
                      <strong>Paseo Verde Park:</strong> 19-acre park with
                      splash pad, tennis courts, playground.
                    </li>
                    <li>
                      <strong>Green Valley Athletic Club:</strong> Full-service
                      gym with pools, tennis, dining.
                    </li>
                    <li>
                      <strong>Legacy Golf Club:</strong> Challenging 18-hole
                      public course designed by Arthur Hills.
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <p className="mt-8">
                The current Green Valley market shows{" "}
              ...
              <p>
                ...
                agent in Green Valley means understanding the subtle differences
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <p className="text-slate-600">
                  As of January 2026, Green Valley's median home price is
                  $520,000, with 4.8% appreciation year-over-year. Prices range
                  from $400,000 for smaller homes to over $1.2 million for
                  luxury properties.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <p className="text-slate-600">
                  Green Valley homes average 26 days on market. Properties near
                  The District at Green Valley Ranch and those with upgraded
                  features often sell faster, sometimes within the first two
                  weeks.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                <h3 className="font-bold text-slate-900 mb-2">
                  What makes Green Valley different from newer Henderson
                  communities?
                </h3>
                <p className="text-slate-600">
                  Green Valley, established in 1988, offers what newer
                  communities can't: mature trees, established schools with
                  proven track records, larger lots, and a genuine sense of
