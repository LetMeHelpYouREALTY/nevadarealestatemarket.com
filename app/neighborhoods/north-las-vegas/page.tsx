...
export const metadata: Metadata = {
  alternates: {
    canonical:
      "https://www.nevadarealestatemarket.com/neighborhoods/north-las-vegas",
  },
  title: "Berkshire Hathaway HomeServices North Las Vegas | Affordable Homes",
  description:
    "Find affordable North Las Vegas homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy helps first-time buyers and investors. Median price $385K. Call (702) 500-1955.",
  keywords: [
  ...
  return (
    <>
      ...
      <PageHero
        ...
        subtitle="Berkshire Hathaway HomeServices North Las Vegas real estate guidance from Dr. Jan Duffy — Nevada Real Estate Market."
        className="pt-24"
      />
        ...
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <div className="prose prose-lg max-w-none text-slate-700">
              ...
              <HeadingPhoto heading="North Las Vegas: The Valley's Best Value for First-Time Buyers" />
              <p>
              ...
              <div className="grid md:grid-cols-2 gap-8 not-prose">
                <div className="bg-slate-50 p-6 rounded-xl">
                  ...
                  <p className="text-slate-600">
                    ...
                    first-time buyers, relocators, and investors. Entry-level
                    homes start in the $320,000s, while new construction from
                    quality builders ranges from $380,000 to $550,000—prices
                    that would buy a condo elsewhere.
                  </p>
                </div>
                <div className="bg-slate-50 p-6 rounded-xl">
                  <div className="flex items-center mb-4">
