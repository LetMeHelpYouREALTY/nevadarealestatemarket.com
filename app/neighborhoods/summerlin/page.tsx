...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://www.nevadarealestatemarket.com/neighborhoods/summerlin",
  },
  title:
    "Berkshire Hathaway HomeServices Summerlin | Las Vegas Luxury Real Estate",
  description:
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-slate-600">
              Discover Las Vegas's premier master-planned community with Dr. Jan
              Duffy, your trusted{" "}
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <div className="prose prose-lg max-w-none text-slate-700">
              ...
              <p>
                ...
                spans 22,500 acres along the western rim of the Las Vegas
                Valley. The community offers an unparalleled lifestyle with Red
                Rock Canyon as its backdrop—providing hiking, biking, and
                outdoor recreation just minutes from your front door. With over
                150 parks, 150 miles of trails, and nine golf courses, Summerlin
                residents enjoy an active, healthy lifestyle that's hard to find
              ...
              <p>
                ...
                has deep roots in Summerlin, and our agents understand the
                nuances of each village—from the amenity-rich atmosphere of The
                Paseos to the luxury estates of The Ridges. Whether you're a
                first-time buyer looking at condos in Affinity or a move-up
                buyer seeking a custom home in Red Rock Country Club, BHHS has
              ...
              <div className="grid md:grid-cols-2 gap-8 not-prose">
                <div className="bg-slate-50 p-6 rounded-xl">
                  ...
                  <p className="text-slate-600">
                    Summerlin's western location provides unmatched access to
                    Red Rock Canyon National Conservation Area. Residents enjoy
                    world-class hiking, rock climbing, and scenic drives within
                    a 10-minute drive. The community's trail system connects
                    directly to Red Rock, making outdoor adventures a daily
                    possibility.
                  </p>
                </div>
                <div className="bg-slate-50 p-6 rounded-xl">
                ...
                <table className="w-full bg-white border border-slate-200 rounded-lg">
                  ...
                  <tbody className="divide-y divide-slate-200">
                    ...
                    <tr className="bg-slate-50">
                      ...
                      <td className="px-4 py-3">22 miles</td>
                      <td className="px-4 py-3">28 min</td>
              ...
              <div className="not-prose grid md:grid-cols-2 gap-6">
                <div className="bg-slate-50 rounded-xl p-6">
                  ...
                  <ul className="text-slate-600 text-sm space-y-2">
                    <li>
                      <strong>Downtown Summerlin:</strong> 125+ stores,
                      restaurants, movie theater. Apple, Nordstrom, Williams
                      Sonoma.
                    </li>
                    <li>
                      <strong>Boca Park:</strong> Trader Joe's, Whole Foods,
                      local restaurants on West Charleston.
                    </li>
                    <li>
                      <strong>Tivoli Village:</strong> Upscale outdoor shopping
                      with Restoration Hardware, boutiques, and fine dining.
                    </li>
                    <li>
                      <strong>Red Rock Casino Resort:</strong> Gaming, spa,
                      multiple restaurants including T-Bones Chophouse.
                    </li>
                  </ul>
                </div>
                <div className="bg-slate-50 rounded-xl p-6">
                  ...
                  <ul className="text-slate-600 text-sm space-y-2">
                    <li>
                      <strong>Summerlin Hospital:</strong> Full-service hospital
                      with ER, labor & delivery, cardiology center.
                    </li>
                    <li>
                      <strong>Red Rock Medical Campus:</strong> Outpatient
                      surgery, imaging, specialty clinics.
                    </li>
                    <li>
                      <strong>Dignity Health:</strong> Multiple urgent care and
                      primary care locations throughout Summerlin.
                    </li>
                    <li>
                      <strong>Southwest Medical:</strong> Multi-specialty
              ...
              <p className="mt-8">
                The current Summerlin real estate market shows strong demand
                with <strong>342 active listings</strong> and an average of just{" "}
                <strong>22 days on market</strong>. The median home price of{" "}
                <strong>$625,000</strong> represents solid appreciation while
                still offering value compared to similar communities in
                California. Buyers relocating from the West Coast find that
                Summerlin delivers a comparable lifestyle at a fraction of the
                cost—with no state income tax.
              </p>
              <p>
                Working with a <strong>Berkshire Hathaway HomeServices</strong>{" "}
                agent gives you access to listings before they hit the market,
                expert negotiation skills, and the backing of a globally trusted
                brand. Dr. Jan Duffy has been serving Summerlin since 2013,
                which means you'll have insights that online searches simply
                can't provide—from which streets have the best mountain views to
                which builders offer the best construction quality.
              </p>
            </div>
          </section>
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            <div className="bg-blue-50 border-l-4 border-blue-600 rounded-lg p-8">
              <blockquote className="text-lg text-slate-700 italic mb-4">
                "Summerlin isn't just a neighborhood—it's a lifestyle. I've been
                serving this area since 2013, and I can tell you which villages
                sit closest to Downtown Summerlin, Red Rock Canyon, and the
                trail network. That local knowledge is what sets Berkshire
                Hathaway HomeServices apart."
              </blockquote>
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <p className="text-slate-600">
                  As of January 2026, the median home price in Summerlin is
                  $625,000, representing a 6.8% increase year-over-year. Luxury
                  homes in The Ridges and other guard-gated communities can
                  exceed $2 million.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <p className="text-slate-600">
                  Summerlin homes currently average 22 days on market, faster
                  than the Las Vegas Valley average of 28 days. Well-priced
                  homes in desirable villages often receive multiple offers
                  within the first week.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                <h3 className="font-bold text-slate-900 mb-2">
                  What makes Summerlin different from other Las Vegas
                  communities?
                </h3>
                <p className="text-slate-600">
                  Summerlin offers 150+ parks, 150+ miles of trails, parks and
                  trails, and stunning Red Rock Canyon views. The Howard Hughes
                  Corporation has developed Summerlin with careful planning
                  since 1990, creating distinct villages each with unique
                  character.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                <h3 className="font-bold text-slate-900 mb-2">
                  Why should I use a Berkshire Hathaway HomeServices agent in
                  Summerlin?
                </h3>
                <p className="text-slate-600">
                  Berkshire Hathaway HomeServices agents like Dr. Jan Duffy
                  bring deep Summerlin expertise combined with the global
                  resources and trusted reputation of the BHHS brand. This
                  combination helps buyers compete in Summerlin's competitive
                  market and helps sellers maximize their home's value.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="text-center bg-blue-600 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-blue-100 mb-8">
              ...
              Summerlin specialist, for a personalized home search or free
              market analysis.
            </p>
            <a
