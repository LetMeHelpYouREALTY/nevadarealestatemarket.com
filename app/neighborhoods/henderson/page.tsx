...
export const metadata: Metadata = {
  alternates: { canonical: "https://www.nevadarealestatemarket.com/neighborhoods/henderson" },
...
const neighborhoodSchema = {
  ...
  description: "Nevada's second-largest city known for safety, schools, and amenity-rich communities",
  geo: {
    "@type": "GeoCoordinates",
    latitude: "36.0395",
    longitude: "-114.9817",
      ...
      <main className="pt-8 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <h2 className="sr-only">Berkshire Hathaway HomeServices Henderson</h2>
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <div className="prose prose-lg max-w-none text-slate-700">
              ...
              <p>
                ...
                schools, walkable amenities rates, and community-oriented atmosphere create an environment where
              ...
              <div className="grid md:grid-cols-2 gap-8 not-prose">
                <div className="bg-slate-50 p-6 rounded-xl">
                  <div className="flex items-center mb-4">
                    ...
                    <h4 className="font-bold text-slate-900 text-lg">Henderson's amenity-rich</h4>
                  </div>
                  <p className="text-slate-600">
                    ...
                    active neighborhood watch programs contribute to exceptionally walkable amenities rates that give
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <p className="text-slate-600">
                  ...
                  Inspirada (resort-style amenities), MacDonald Highlands (luxury), Anthem (park-centered),
