...
export const metadata: Metadata = {
  alternates: {
    canonical:
      "https://www.nevadarealestatemarket.com/neighborhoods/skye-canyon",
  },
  title: "Berkshire Hathaway HomeServices Skye Canyon | Northwest Las Vegas",
  description:
    "Find Skye Canyon homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy specializes in this premier northwest community. Median price $550K. Call (702) 500-1955.",
  keywords: [
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-slate-600">
              Northwest Las Vegas's fastest-growing community. Discover Skye
              Canyon with <strong>Berkshire Hathaway HomeServices</strong> and
              Dr. Jan Duffy.
            </p>
          </div>
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <div className="prose prose-lg max-w-none text-slate-700">
              ...
              <p>
                ...
                Las Vegas has quickly become one of the valley's most
                sought-after addresses, consistently ranking among the nation's
                top-selling master-planned communities.{" "}
                <strong>Berkshire Hathaway HomeServices</strong> is proud to
                help buyers discover what makes Skye Canyon special.
              </p>
              <p>
                What sets Skye Canyon apart is Skye Center—a stunning 15-acre
                amenity complex that rivals resort facilities. The facility
                features multiple pools including a zero-entry family pool and
                lap pool, a state-of-the-art fitness center, tennis and
                pickleball courts, and flexible event spaces that host community
                gatherings throughout the year. From summer movie nights to
                holiday celebrations, Skye Center creates the kind of community
                connections that transform neighborhoods into true communities.
              </p>
              <p>
                <strong>
                  Berkshire Hathaway HomeServices Nevada Properties
                </strong>{" "}
                offers free buyer representation on all Skye Canyon new
                construction purchases. This is crucial because when you walk
                into a builder's sales center, those agents work for the
                builder—not you. Dr. Jan Duffy represents your interests,
                negotiates upgrades, reviews contracts for hidden pitfalls, and
                ensures you're getting fair value. This service costs buyers
                ...
                <div className="bg-slate-50 p-6 rounded-xl">
                  <div className="flex items-center mb-4">
                    ...
                    <h4 className="font-bold text-slate-900 text-lg">
                      Skye Center Amenities
                    </h4>
                  </div>
                  <p className="text-slate-600">
                    Skye Center is the community's social hub, featuring
                    resort-style pools, a modern fitness center, sports courts,
                    and community gathering spaces. The facility hosts
                    year-round events from outdoor movie nights to fitness
                    classes, creating a vibrant community atmosphere. Nothing
                    else in northwest Las Vegas compares.
                  </p>
                </div>
                <div className="bg-slate-50 p-6 rounded-xl">
                  <div className="flex items-center mb-4">
                    ...
                    <h4 className="font-bold text-slate-900 text-lg">
                      Mountain Views & Open Space
                    </h4>
                  </div>
                  <p className="text-slate-600">
                    Skye Canyon's position at the base of the mountains provides
                    stunning views and easy access to outdoor recreation.
                    Adjacent Floyd Lamb Park offers 680 acres of lakes,
                    wildlife, and natural beauty. The community's trail system
                    connects to regional paths, perfect for walking, running,
                    and cycling.
                  </p>
                </div>
              </div>
              ...
              <div className="not-prose overflow-x-auto">
                <table className="w-full bg-white border border-slate-200 rounded-lg">
                  ...
                  <tbody className="divide-y divide-slate-200">
                    ...
                    <tr className="bg-slate-50">
                      <td className="px-4 py-3">Centennial Hills</td>
                      <td className="px-4 py-3">5 miles</td>
                      <td className="px-4 py-3">10 min</td>
                      <td className="px-4 py-3">12-18 min</td>
                    </tr>
                    <tr>
                      <td className="px-4 py-3">Floyd Lamb Park</td>
                      <td className="px-4 py-3">Adjacent</td>
              ...
              <div className="not-prose grid md:grid-cols-2 gap-6">
                <div className="bg-slate-50 rounded-xl p-6">
                  ...
                  <ul className="text-slate-600 text-sm space-y-2">
                    <li>
                      <strong>Toll Brothers:</strong> Luxury homes from
                      $600K-$800K. Known for quality and customization.
                    </li>
                    <li>
                      <strong>Woodside Homes:</strong> Mid-range to premium,
                      $500K-$700K. Strong value.
                    </li>
                    <li>
                      <strong>Shea Homes:</strong> Energy-efficient designs,
                      $550K-$750K.
                    </li>
                  </ul>
                </div>
                <div className="bg-slate-50 rounded-xl p-6">
                  ...
                  <ul className="text-slate-600 text-sm space-y-2">
                    <li>
                      <strong>Lennar:</strong> Entry to mid-range, $450K-$600K.
                      "Everything's Included" packages.
                    </li>
                    <li>
                      <strong>KB Home:</strong> Energy Star certified,
                      $420K-$550K. Customization options.
                    </li>
                    <li>
              ...
              <p className="mt-8">
                The current Skye Canyon market shows{" "}
                <strong>124 active listings</strong> with homes averaging just{" "}
              ...
              <p>
                ...
                your Skye Canyon purchase means working with agents who know
                which builders offer the best quality, which lots have the best
                views, and which upgrades deliver the best value. Dr. Jan Duffy
                has helped dozens of families find their Skye Canyon homes, and
                that experience translates into better outcomes for buyers
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <p className="text-slate-600">
                  As of January 2026, Skye Canyon's median home price is
                  $550,000, up 5.5% year-over-year. New construction ranges from
                  $450,000 to $800,000, while resales offer additional options
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <p className="text-slate-600">
                  Skye Canyon features Skye Center, a 15-acre amenity complex
                  with resort-style pools, fitness center, sports courts, and
                  event spaces. The community also offers miles of trails,
                  parks, and is adjacent to Floyd Lamb Park.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                <h3 className="font-bold text-slate-900 mb-2">
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                <h3 className="font-bold text-slate-900 mb-2">
                  Why use Berkshire Hathaway HomeServices for Skye Canyon new
                  construction?
                </h3>
                <p className="text-slate-600">
                  BHHS provides free buyer representation on new construction
                  purchases—the builder pays our commission. Dr. Jan Duffy can
                  negotiate upgrades, review contracts, and ensure your
                  interests are protected when builder sales agents work for the
                  builder.
                </p>
              </div>
            </div>
          ...
          <section className="text-center bg-blue-600 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Contact Dr. Jan Duffy, your Berkshire Hathaway HomeServices Skye
              Canyon specialist, for expert guidance on new construction and
              resale homes.
            </p>
            <a
