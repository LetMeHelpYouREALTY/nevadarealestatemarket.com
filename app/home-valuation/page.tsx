...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://www.nevadarealestatemarket.com/home-valuation",
  },
  title:
    "Free Home Valuation Las Vegas | What's Your Home Worth? | Berkshire Hathaway HomeServices",
  description:
    "Get a free, accurate home valuation in Las Vegas from Dr. Jan Duffy at Berkshire Hathaway HomeServices. Expert CMA analysis for Summerlin, Henderson, Green Valley & all Las Vegas neighborhoods. Call (702) 500-1955.",
  keywords: [
...
export default function HomeValuationPage() {
  return (
    <>
      ...
      <Navbar />
      <PageHero
        hero={getHeroImageByKey("home-valuation")}
        badge="Free Home Valuation"
        title="What's Your Las Vegas Home Worth?"
        subtitle="Get a data-backed estimate for your Las Vegas Valley home."
        className="pt-24"
      />
      <main className="pt-8 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <h2 className="sr-only">What's Your Las Vegas Home Worth?</h2>
            ...
            <div className="space-y-8">
              <div className="bg-slate-900 text-white rounded-lg p-8">
                ...
                <p className="text-slate-300 mb-6">
                  ...
                  Las Vegas since 2013. The result? Accurate pricing that helps
