...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://www.nevadarealestatemarket.com/sellers/divorce-probate",
  },
  title:
    "Divorce & Probate Home Sales Las Vegas | Berkshire Hathaway HomeServices",
  description:
    "Sensitive real estate situations handled with discretion. Dr. Jan Duffy helps with divorce sales, probate, estate liquidation, and court-ordered sales. Call (702) 500-1955.",
  keywords: [
...
export default function DivorceProbatePage() {
  return (
    <>
      <Navbar />
      <PageHero
        hero={getHeroImageByKey("sellers-divorce-probate")}
        title="Divorce Probate"
        subtitle="Divorce Probate real estate guidance from Dr. Jan Duffy — Nevada Real Estate Market."
        className="pt-24"
      />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            >
              ...
              Confidential Consultation → (702) 500-1955
            </a>
          </div>
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <HeadingPhoto heading="Situations We Help Navigate" />
