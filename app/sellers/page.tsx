...
export default function SellersPage() {
  return (
    <>
      ...
      <Navbar />
      <PageHero
        hero={getHeroImageByKey("sellers")}
        badge="Seller Representation"
        title="Sell Your Las Vegas Home for Top Dollar"
        subtitle="Sell your Nevada home with data-backed pricing and full marketing."
        className="pt-24"
      />
      <main className="pt-8 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <h2 className="sr-only">Sell Your Las Vegas Home for Top Dollar</h2>
            <p className="text-xl text-slate-600 mb-8">
              When you list with{" "}
              <strong>Berkshire Hathaway HomeServices</strong>, you get
              world-class marketing, expert pricing, and a name that buyers
              trust. Dr. Jan Duffy has been serving Las Vegas since 2013—helping
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            ...
            <div className="bg-slate-50 rounded-lg p-8">
              <blockquote className="text-lg text-slate-700 italic mb-4">
                ...
                Vegas since 2013 to price homes right the first time. The
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-blue-100 mb-6">
                  ...
                  2013, you'll know exactly what your home could sell for in
