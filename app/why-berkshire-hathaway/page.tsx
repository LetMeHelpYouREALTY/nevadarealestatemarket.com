...
export const metadata: Metadata = {
  alternates: { canonical: "https://www.nevadarealestatemarket.com/why-berkshire-hathaway" },
...
const organizationSchema = {
  ...
  logo: "https://www.nevadarealestatemarket.com/favicon-32x32.png",
  description:
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-slate-700 mb-6">
                  ...
                  since 2013 with $127M+ in closed transactions, you get global brand strength
                  with hometown expertise.
                </p>
                <ul className="space-y-3 mb-8">
                  {[
                    "Serving Las Vegas since 2013",
