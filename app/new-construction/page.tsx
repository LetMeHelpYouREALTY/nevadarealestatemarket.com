...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://www.nevadarealestatemarket.com/new-construction",
  },
  title:
      ...
      <main className="pt-8 pb-16">
        <div className="container mx-auto px-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-amber-800 text-sm">
                    ...
                    <a href="tel:+17025001955" className="font-bold underline">
                      (702) 500-1955
                    </a>{" "}
          ...
          <section className="mb-16 bg-blue-600 text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            ...
            <HeadingPhoto heading="Why Use a BHHS Agent for New Construction?" />
          ...
          <section className="text-center bg-blue-600 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Call <strong>(702) 500-1955</strong> to register Dr. Jan Duffy as
              your buyer's agent
