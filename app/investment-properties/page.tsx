...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://www.nevadarealestatemarket.com/investment-properties",
  },
  title: "Las Vegas Investment Properties | Berkshire Hathaway HomeServices",
  description:
    "Invest in Las Vegas real estate with Dr. Jan Duffy at Berkshire Hathaway HomeServices Nevada Properties. Rental properties, ROI analysis, 1031 exchanges. No state income tax. Call (702) 500-1955.",
  keywords: [
...
export default function InvestmentPropertiesPage() {
  return (
    <>
      <Navbar />
      <PageHero
        hero={getHeroImageByKey("investment-properties")}
        badge="Investment Properties"
        title="Las Vegas Investment Properties"
        subtitle="Rental and portfolio opportunities in Clark County."
        className="pt-24"
      />
      <main className="pt-8 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <h2 className="sr-only">Las Vegas Investment Properties</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl p-6">
                ...
                <p className="text-slate-600 mb-4">
                  ...
                  quality, nearby parks and trails, and steady appreciation.
                  Lower vacancy rates and longer tenant retention offset
