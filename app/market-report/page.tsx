...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://www.nevadarealestatemarket.com/market-report",
  },
  title:
...
export default function MarketReportPage() {
  return (
    <>
      ...
      <Navbar />
      <PageHero
        hero={getHeroImageByKey("market-report")}
        badge="Market Report"
        title="Las Vegas Real Estate Market Report"
        subtitle="Clark County housing data for buyers and sellers."
        className="pt-24"
      />
      <main className="pt-8 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <h2 className="sr-only">Las Vegas Real Estate Market Report</h2>
          ...
          <section className="mb-16 bg-slate-900 text-white rounded-2xl p-8 md:p-12 max-w-6xl mx-auto">
            ...
            <HeadingPhoto heading="Las Vegas Market Snapshot | January 2026" />
