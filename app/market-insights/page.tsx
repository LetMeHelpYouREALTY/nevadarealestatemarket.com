...
export default function MarketInsightsPage() {
  return (
    <>
      ...
      <Navbar />
      <PageHero
        hero={getHeroImageByKey("market-insights")}
        badge="Market Insights"
        title="Las Vegas Market Insights"
        subtitle="Neighborhood-level Nevada real estate analysis."
        className="pt-24"
      />
      <main className="pt-8 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <h2 className="sr-only">Las Vegas Market Insights</h2>
          ...
          <section className="mb-16 bg-slate-50 rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl p-6 border border-slate-200">
                ...
                <p className="text-slate-600 text-sm mb-3">
                  Red Rock views, Downtown Summerlin, and parks and trails
                  maintain premium positioning. Limited new inventory keeps
                  values strong.
                </p>
                <div className="text-sm text-slate-500">
              ...
              <div className="bg-white rounded-xl p-6 border border-slate-200">
                ...
                <p className="text-slate-600 text-sm mb-3">
                  Amenity-rich community with the valley's largest park. New
